...
const images: GalleryImage[] = [
  ...
  { src: "/images/ancient-cedar.webp", alt: "Ancient hollow cedar trunk", category: "Grounds" },
  { src: "/images/cedar-path.webp", alt: "Cedar grove path with rhododendrons", category: "Grounds" },
  { src: "/images/dry-creek-maple.webp", alt: "Japanese maple beside the dry stream bed in the cedar grove", category: "Grounds" },
  { src: "/images/therapy-pools.webp", alt: "Cedar sauna with cold plunge pools in the forest", category: "Grounds" },
  { src: "/images/stone-path-moss.webp", alt: "Mossy stone path through fern beds", category: "Grounds" },
  { src: "/images/cedar-sunlight.webp", alt: "Sunlight through the cedar grove", category: "Grounds" },
  { src: "/images/deer-grove-path.webp", alt: "Deer crossing the dry stream bed path", category: "Grounds" },
  { src: "/images/maple-uplit-night.webp", alt: "Japanese maple uplit at twilight", category: "Grounds" },
